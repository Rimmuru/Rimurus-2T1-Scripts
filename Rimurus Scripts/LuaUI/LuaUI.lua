...
function setUpSprite()
	...
	sprite = scriptdraw.register_sprite(appdata.."scripts\\Rimuru\\Dependancies\\LuaUI\\Banner.png")
end
setUpSprite()
...
function LuaUI.drawStringSlider(text, num, option)
	LuaUI.drawText("< "..tostring(option[LuaUI.Options.sliderValue + 1]).." >", LuaUI.Options.menuPos.x + 0.06, LuaUI.Options.menuPos.y + 0.035 + (0.34 * num/10) + 0.005, 0, 0.3, true, false)
	LuaUI.drawText(tostring(text), LuaUI.Options.menuPos.x, LuaUI.Options.menuPos.y + 0.035 + (0.34 * num/10), 1, 0.5, true, false)
end
