...
for k,v in pairs(commandList) do --bool register_command(string name, string hint, function run, function|nil complete)⚓︎
	commandList[k] = menu.get_feature_by_hierarchy_key(v)
	console.register_command(tostring(commandList[k]), "", function ()
